...
lint: ## check style with flake8
	flake8 chibi_gitlab tests

coverage: ## check code coverage quickly with the default Python
	coverage run --source chibi_gitlab setup.py test
	coverage report -m
	coverage html
	$(BROWSER) coverage_html_report/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/chibi_gitlab.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ chibi_gitlab
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
pep8:
	...
	@pycodestyle --statistics chibi_gitlab tests

flakes:
	@echo "Running flakes tests..."
	@pyflakes chibi_gitlab tests
